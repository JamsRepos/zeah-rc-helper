...
1. Always restart the development client by stopping any running `./gradlew run` process and starting a new one from the plugin's root directory. Do this after every code change — do not wait to be asked.
